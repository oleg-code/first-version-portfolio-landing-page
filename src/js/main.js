$(document).ready(function() {
  ...
  SVGRoadInstanceSmall.setStrokeDashoffsetInPercebtage(progresBarrPercentage);

  ////SECOND CIRCLE PROGRESSBARR//////////////////////////
  ...
  SVGRoadInstanceSmall.setStrokeDasharrayInPercebtage(100);
  SVGRoadInstanceSmall.setStrokeDashoffsetInPercebtage(progresBarrPercentage2);

  ////THIRD CIRCLE PROGRESSBARR//////////////////////////
  ...
  SVGRoadInstanceSmall.setStrokeDasharrayInPercebtage(100);
  SVGRoadInstanceSmall.setStrokeDashoffsetInPercebtage(progresBarrPercentage3);

  /// ANIMATED COUNTER FOR CIRCLE PROGRES BARR//////////////
  $({ countNum: $(".barrPercentage").html() }).animate(
    {
